...
document.addEventListener("DOMContentLoaded", function () {
    ...
    welcomeMessage.classList.add("chat-message", "incoming-message");
    welcomeMessage.innerHTML = "<b>OkehAi:</b> Hello! I'm OkehAi Created by Team Xy! How can I assist you today?";
